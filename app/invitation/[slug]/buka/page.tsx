    ...
    <main className="relative bg-slate-50 min-h-screen text-slate-800 selection:bg-gold-accent/30">
      ...
      <section id="acara" className="py-24 px-6 bg-navy-dark text-white relative">
        ...
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Akad Nikah */}
            <ScrollAnimate type="fade-right" delay={0.1} className="h-full flex flex-col">
              <div className="glass-navy p-8 rounded-2xl border border-gold-accent/30 text-center space-y-6 flex flex-col justify-between h-full">
                ...
                <div className="text-xs text-slate-400 bg-navy-dark/40 p-3 rounded-lg border border-white/5 mt-4">
                  Keluarga & Saksi Akad
                </div>
              </div>
            </ScrollAnimate>
            ...
            {/* Resepsi */}
            <ScrollAnimate type="fade-left" delay={0.2} className="h-full flex flex-col">
              <div className="glass-navy p-8 rounded-2xl border border-gold-accent/30 text-center space-y-6 flex flex-col justify-between h-full">
                <div className="space-y-4">
                  <div className="w-12 h-12 rounded-full bg-gold-accent/15 text-gold-accent flex items-center justify-center mx-auto border border-gold-accent/25">
                    <Calendar className="w-5 h-5" />
      ...
      <section id="galeri" className="py-24 px-6 bg-white bg-wedding-pattern bg-blend-overlay bg-white/95 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto space-y-12 relative z-10">
          ...
          <ScrollAnimate type="scale-up" delay={0.15}>
            <Gallery />
          </ScrollAnimate>
        </div>
      </section>
      ...
      <section id="amplop" className="py-24 px-6 bg-slate-50 bg-wedding-pattern bg-blend-overlay bg-slate-50/95 relative overflow-hidden">
        ...
        <div className="max-w-xl mx-auto space-y-12 relative z-10">
          ...
          <div className="space-y-6">
            ...
            {/* DANA Rika */}
            <ScrollAnimate type="fade-up" delay={0.2}>
              <div className="glass-white p-6 rounded-2xl border border-gold-accent/20 shadow-md text-center space-y-4">
